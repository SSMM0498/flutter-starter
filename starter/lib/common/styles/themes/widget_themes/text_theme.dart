...
class CustomTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: AppColors.dark),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 13.0, fontWeight: FontWeight.w500, color: AppColors.dark.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: AppColors.light),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 13.0, fontWeight: FontWeight.w500, color: AppColors.light.withOpacity(0.5)),
